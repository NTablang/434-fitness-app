...
export const CustomButton = ({ onClick, label, className }) => {
  return (
    <div
      colorScheme="twitter"
      className={`!text-2xl !px-16 !py-4 text-white font-[700] tracking-tight !rounded-full blue-bg cursor-pointer ${className}`}
      onClick={onClick}
    >
      {label}
    </div>
